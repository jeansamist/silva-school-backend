...
from api.views.studentViews import StudentView, StudenListView, StudentDetailView
...
from api.views.paymentViews import ClassLevelPaymentTypeView
...
urlpatterns = [
    ...
    path("payment/classlevelpayment", ClassLevelPaymentTypeView.as_view()),
    path("class/<int:class_level_pk>/classroom", ClassRoomView.as_view()),
    path(
        "class/<int:class_level_pk>/classroom/<int:classroom_pk>/student",
        StudenListView.as_view(),
    ),
    path("student", StudentView.as_view()),
    path("student/<int:student_pk>", StudentDetailView.as_view()),
]
