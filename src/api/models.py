...
class School(TimespamtedModel):
    ...
    image = models.ImageField(upload_to=school_image_upload_path, blank=True, null=True)
...
class User(Person):
    ...
    role = models.ForeignKey(
        Role, related_name="users", on_delete=models.CASCADE, blank=True, null=True
    )
...
class Payment(TimespamtedModel):
...
class ClassLevel(TimespamtedModel):
    ...
    payment = models.ForeignKey(
        Payment, related_name="class_levels", on_delete=models.CASCADE
    )
